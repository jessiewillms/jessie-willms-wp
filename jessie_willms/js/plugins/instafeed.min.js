...
var feed = new Instafeed({
    get: 'user',
    userId: '17132104',
    accessToken: '17132104.9d1b0b5.5ff1352a7b8b465bae74a83de872002a',
    clientId: '90716e5737d14dee9062b576a8078d4d',
    resolution: 'standard_resolution',
    sortBy: 'most-liked',
    limit: '5',
    template: '<li class="col-3"><a href="{{link}}" target="_blank"><img src="{{image}}" /></a></li>',
});
feed.run();